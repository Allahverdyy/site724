        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-slate-200 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500">
            ...
            <div className="flex gap-6">
              <a href="/gizlilik-politikasi" className="hover:text-slate-900">Gizlilik Politikası</a>
              <a href="/kullanim-sartlari" className="hover:text-slate-900">Kullanım Şartları</a>
            </div>
          </div>
        </div>
      </footer>
